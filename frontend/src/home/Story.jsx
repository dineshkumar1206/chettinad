  ...
  return (
    <div className="w-full min-h-screen relative flex items-center justify-center py-12 lg:py-20 overflow-hidden">
      ...
      <div className="w-full max-w-7xl mx-auto flex flex-col items-center justify-center px-4 sm:px-8 md:px-12 lg:px-16 relative z-10 text-center">
        ...
        >
          <p className="text-xl sm:text-2xl md:text-3xl text-[#782312] font-serif italic mb-4" style={{fontFamily: "'Just Another Hand', 'Comic Sans MS', cursive"}}>
            Now you're probably wondering...
          </p>
          
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-[56px] font-serif text-[#1e2917] font-bold leading-[1.1] tracking-tight uppercase mb-4">
            BUT WHAT MAKES<br />
            IT CHETTINAD?
          </h2>
          ...
          <p className="text-xl sm:text-2xl md:text-3xl text-[#1e2917] font-serif mt-2 mb-2">
            It isn't simply the heat of the chilli.
          </p>
          
          <p className="text-3xl sm:text-4xl md:text-5xl text-[#1e2917] font-serif font-bold mb-4">
            It's the layers.
          </p>

          <p className="text-lg sm:text-xl md:text-2xl text-[#782312] font-serif font-medium mb-8">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-center gap-6 md:gap-10 text-left w-full mt-6">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="bg-[#782312] text-white rounded-full px-8 py-3 md:px-10 md:py-4 text-sm md:text-base font-bold tracking-widest transition-all duration-300 flex items-center gap-2 lg:gap-3 shadow-lg mx-auto mt-12"
          >
            And that's where our story begins. <span className="text-lg lg:text-xl">&rarr;</span>
          </motion.button>
