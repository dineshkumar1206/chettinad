  ...
  return (
    <div className="w-full min-h-screen lg:h-screen flex flex-col lg:flex-row items-stretch justify-between overflow-hidden bg-transparent">
        ...
        <div className="max-w-lg mx-auto ml-10 sm:ml-16 lg:ml-32 xl:ml-48 flex flex-col items-start w-full">
          ...
          <div className="flex flex-col gap-4 w-full mt-2">
            ...
            <div className="flex items-start gap-4">
              <div className="w-[48px] h-[48px] rounded-full bg-[#8c3a21] flex-shrink-0 flex items-center justify-center text-white">
            ...
            <div className="flex items-start gap-4">
              <div className="w-[48px] h-[48px] rounded-full bg-[#8c3a21] flex-shrink-0 flex items-center justify-center text-white">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M3 18h18"/><path d="M4 18a8 8 0 0 1 16 0"/><path d="M12 7V5"/><path d="M10 5h4"/></svg>
              </div>
              <div className="flex flex-col pt-1">
            ...
            <div className="flex items-start gap-4">
              <div className="w-[48px] h-[48px] rounded-full bg-[#8c3a21] flex-shrink-0 flex items-center justify-center text-white">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
              </div>
              <div className="flex flex-col pt-1">
      ...
      <motion.div 
        ...
        className="w-full lg:w-[55%] xl:w-[55%] h-[50vh] lg:h-full relative order-1 lg:order-2 ml-auto"
      >
        <img 
